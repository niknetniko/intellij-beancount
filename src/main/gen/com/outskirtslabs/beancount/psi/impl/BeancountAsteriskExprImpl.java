...
public class BeancountAsteriskExprImpl extends BeancountNumberExprImpl implements BeancountAsteriskExpr {

  public BeancountAsteriskExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitAsteriskExpr(this);
  }
