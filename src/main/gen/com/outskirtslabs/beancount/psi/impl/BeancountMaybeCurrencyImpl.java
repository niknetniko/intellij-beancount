...
public class BeancountMaybeCurrencyImpl extends ASTWrapperPsiElement implements BeancountMaybeCurrency {

  public BeancountMaybeCurrencyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitMaybeCurrency(this);
  }
