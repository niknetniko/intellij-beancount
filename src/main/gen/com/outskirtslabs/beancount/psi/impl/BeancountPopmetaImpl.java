...
public class BeancountPopmetaImpl extends ASTWrapperPsiElement implements BeancountPopmeta {

  public BeancountPopmetaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPopmeta(this);
  }
