...
public class BeancountCurrencyOneImpl extends BeancountCurrencyListImpl implements BeancountCurrencyOne {

  public BeancountCurrencyOneImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCurrencyOne(this);
  }
