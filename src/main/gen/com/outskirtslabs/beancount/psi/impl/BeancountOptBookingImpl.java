...
public class BeancountOptBookingImpl extends ASTWrapperPsiElement implements BeancountOptBooking {

  public BeancountOptBookingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitOptBooking(this);
  }
