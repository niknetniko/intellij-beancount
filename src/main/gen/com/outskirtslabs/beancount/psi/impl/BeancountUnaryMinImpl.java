...
public class BeancountUnaryMinImpl extends BeancountNumberExprImpl implements BeancountUnaryMin {

  public BeancountUnaryMinImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitUnaryMin(this);
  }
