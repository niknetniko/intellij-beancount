...
public class BeancountPriceAnnotationImpl extends ASTWrapperPsiElement implements BeancountPriceAnnotation {

  public BeancountPriceAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPriceAnnotation(this);
  }
