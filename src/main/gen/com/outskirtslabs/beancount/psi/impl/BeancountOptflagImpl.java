...
public class BeancountOptflagImpl extends ASTWrapperPsiElement implements BeancountOptflag {

  public BeancountOptflagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitOptflag(this);
  }
