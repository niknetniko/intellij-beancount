...
public class BeancountTagsLinksImpl extends ASTWrapperPsiElement implements BeancountTagsLinks {

  public BeancountTagsLinksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitTagsLinks(this);
  }
