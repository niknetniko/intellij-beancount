...
public abstract class BeancountCurrencyListImpl extends ASTWrapperPsiElement implements BeancountCurrencyList {

  public BeancountCurrencyListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCurrencyList(this);
  }
