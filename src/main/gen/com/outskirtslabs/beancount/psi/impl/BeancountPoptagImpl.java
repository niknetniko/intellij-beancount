...
public class BeancountPoptagImpl extends ASTWrapperPsiElement implements BeancountPoptag {

  public BeancountPoptagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPoptag(this);
  }
