...
public class BeancountPushmetaImpl extends ASTWrapperPsiElement implements BeancountPushmeta {

  public BeancountPushmetaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitPushmeta(this);
  }
