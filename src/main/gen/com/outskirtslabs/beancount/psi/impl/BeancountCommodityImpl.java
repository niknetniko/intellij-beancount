...
public class BeancountCommodityImpl extends ASTWrapperPsiElement implements BeancountCommodity {

  public BeancountCommodityImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCommodity(this);
  }
