...
public class BeancountMaybeNumberImpl extends ASTWrapperPsiElement implements BeancountMaybeNumber {

  public BeancountMaybeNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitMaybeNumber(this);
  }
