...
public class BeancountIncompleteAmountImpl extends ASTWrapperPsiElement implements BeancountIncompleteAmount {

  public BeancountIncompleteAmountImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitIncompleteAmount(this);
  }
