...
public class BeancountBalanceImpl extends ASTWrapperPsiElement implements BeancountBalance {

  public BeancountBalanceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitBalance(this);
  }
  ...
  public BeancountAmountTolerance getAmountTolerance() {
    return findNotNullChildByClass(BeancountAmountTolerance.class);
  }
