...
public class BeancountCustomValueImpl extends ASTWrapperPsiElement implements BeancountCustomValue {

  public BeancountCustomValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BeancountVisitor visitor) {
    visitor.visitCustomValue(this);
  }
  ...
  public BeancountAmount getAmount() {
    return findChildByClass(BeancountAmount.class);
  }
