...
public class BeancountKeyValueListImpl extends ASTWrapperPsiElement implements BeancountKeyValueList {

  public BeancountKeyValueListImpl(@NotNull ASTNode node) {
    super(node);
  }
